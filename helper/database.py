...
DB_NAME = os.environ.get("DB_NAME","Unrated")
DB_URL = os.environ.get("DB_URL","mongodb+srv://Unrated:Unrated@cluster0.7n4fr0l.mongodb.net/?retryWrites=true&w=majority")
